...
import styles from './GraphDemo.module.scss';
import { IGraphDemoProps } from './IGraphDemoProps';
import { IGraphDemoState } from './IGraphDemoState';
...
export default class GraphDemo extends React.Component<IGraphDemoProps, IGraphDemoState> {
  ...
  constructor(props: IGraphDemoProps, state: IGraphDemoState) {
    super(props);
  ...
  public render(): React.ReactElement<IGraphDemoProps> {
    return (
