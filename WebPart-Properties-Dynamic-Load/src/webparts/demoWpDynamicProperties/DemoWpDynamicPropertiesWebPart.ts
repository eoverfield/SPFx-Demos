...
import styles from './DemoWpDynamicProperties.module.scss';
import * as strings from 'demoWpDynamicPropertiesStrings';
import { IDemoWpDynamicPropertiesWebPartProps } from './IDemoWpDynamicPropertiesWebPartProps';
...
export default class DemoWpDynamicPropertiesWebPart extends BaseClientSideWebPart<IDemoWpDynamicPropertiesWebPartProps> {
  ...
  public render(): void {
    this.domElement.innerHTML = `
      <div class="${styles.demoWpDynamicProperties}">
