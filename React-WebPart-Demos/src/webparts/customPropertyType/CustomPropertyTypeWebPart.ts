//based on React custom property webpart by Waldek Mastykarz (MVP, Rencore, @waldekm)
...
import * as strings from 'customPropertyTypeStrings';
import CustomPropertyType from './components/CustomPropertyType';
import { ICustomPropertyTypeProps } from './components/ICustomPropertyTypeProps';
import { ICustomPropertyTypeWebPartProps } from './ICustomPropertyTypeWebPartProps';
...
export default class CustomPropertyTypeWebPart extends BaseClientSideWebPart<ICustomPropertyTypeWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ICustomPropertyTypeProps > = React.createElement(
      CustomPropertyType,
      {
