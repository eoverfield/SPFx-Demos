/**
 * sp-pnp-js v2.0.7 - A JavaScript library for SharePoint development.
        ...
        return util_1.Util.toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this._requests.length; i++) {
                ...
                if (!headers.has("X-ClientService-ClientTag")) {
                    headers.append("X-ClientService-ClientTag", "PnPCoreJS:2.0.7");
                }
...
var decorators_1 = __webpack_require__(43);
...
var sprequestexecutorclient_1 = __webpack_require__(49);
...
var spListConfigurationProvider_1 = __webpack_require__(52);
