...
import styles from './ReactYoutube.module.scss';
import { IReactYoutubeProps } from './IReactYoutubeProps';
import { IReactYoutubeState } from './IReactYoutubeState';
...
export default class ReactYoutube extends React.Component<IReactYoutubeProps, IReactYoutubeState> {
  constructor(props) {
    super(props);
  ...
  public render(): React.ReactElement<IReactYoutubeProps> {
    ...
    return (
      <div className={styles.reactYoutube}>
